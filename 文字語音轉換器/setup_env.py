...
def main():
    ...
    # 4. 安裝 PyTorch GPU 版本
    print("[4/6] 準備安裝 PyTorch GPU 加速版本...")
    print("  (下載 PyTorch 檔案超過 2GB，可能會花費超過 5 分鐘，請保持網路通暢並勿關閉視窗)")
    run_cmd([venv_python, "-m", "pip", "install", "torch", "torchvision", "torchaudio", "--index-url", "https://download.pytorch.org/whl/cu121"], "安裝 PyTorch")
    print()
